...
Route::get('/verify-certificate/{code}', [CertificateVerificationController::class, 'verify']);
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('role:mahasiswa')->group(function () {
        ...
        Route::get('/mahasiswa/kompetensi/{asesmen}/download', [MahasiswaKompetensiController::class, 'download']);
    });
});
